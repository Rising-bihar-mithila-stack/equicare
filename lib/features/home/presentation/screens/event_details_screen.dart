                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              if(event.isCompleted??true?false:true)if(!value)GestureDetector(
                                onTap: () {
                                  CalendarController calendarController =
                                  Get.put(CalendarController(),tag: "calendarController");
                                  // calendarController.setEventForEdit(event: event);
                                  Get.toNamed(appRouteNames.editEventScreen, arguments: {"date": event.startDate?.convertDateFormatToDMYYYY(),
                                  "eventId":event.id})
                                      ?.then(
                                    (value) {
                               ...
                               /*   Get.to(()=>AddEventScreen(fromEdit: true,));*/
                                },
                                child: Container(
                                  margin: EdgeInsets.only(right: 10.w),
                                  padding: EdgeInsets.all(8.w),
                                  decoration: ShapeDecoration(
                                    color: appColors.c313131.withOpacity(0.1),
                                    shape: RoundedRectangleBorder(
                                      side: BorderSide(
                                          width: 1, color: appColors.c313131),
                                      borderRadius: BorderRadius.circular(8),
                                    ),
                                  ),
                                  child: Icon(Icons.edit, color: appColors.c313131,),
                                ),
                              ),
                              GestureDetector(
                                onTap: () {
                                                  ...
                                                  Flexible(
                                                    ...
                                                    onTap: () async {
                                                      ...
                                                      if (await controller
                                                        ...
                                                        Get.back();
                                                        Get.back();
                                                        // Get.off(appRouteNames.eventDetailsScreen);
                                                        // Get.snackbar('Delete',
                                ...
                                child: Container(
                                  ...
                                  padding: EdgeInsets.all(8.w),
                                  decoration: ShapeDecoration(
                                    color: appColors.cFFF4F3,
                                    shape: RoundedRectangleBorder(
                                      side: BorderSide(
                                          width: 1, color: appColors.cEA4335),
                                      borderRadius: BorderRadius.circular(8),
                                    ),
                                  ),
                                  child: SvgPicture.asset(appIcons.deleteIconSvg),
                                ),
                              ),
                            ],
                          )
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                //   onTap: () {
                                    ...
                                    //     eventId: event.id.toString(), index: 0);
                                  // },
                                  // child:
                                  !value
                                      ? AppBlueButton(
                                      ...
                                      onTap: () {
                                        ...
                                        setState(() {});
                                        controller.markEventDone(
                                            eventId: event.id.toString(), index: null, date: event.eventDate??"");
                                      }
                                        )
                                      : Row(
                                          mainAxisAlignment:
...
class EventInfoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          EventDetailsInfoCardWidget(
              title: "Contact", subTitle: event.contactNumber ?? "Richard Williams"),
          EventDetailsInfoCardWidget(
              title: "Location", subTitle: event.location ?? "United States"),
          EventDetailsInfoCardWidget(
              title: "Event", subTitle: event.eventTypeName ?? "Feed"),
          EventDetailsInfoCardWidget(
              title: "Start Time", subTitle: event.startTime?.convertToAmPm() ?? "-----"),
          EventDetailsInfoCardWidget(
              title: "End Time", subTitle: event.endTime?.convertToAmPm() ?? "-----"),
          EventDetailsInfoCardWidget(
              title: "Repeat", subTitle: event.eventRepeat ?? "Never"),
          EventDetailsInfoCardWidget(
            title: "Alert",
            subTitle:event.alert?? "Never",
